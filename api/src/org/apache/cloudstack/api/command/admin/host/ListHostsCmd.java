...
public class ListHostsCmd extends BaseListCmd {
    ...
    @Parameter(name = ApiConstants.HYPERVISOR, type = CommandType.STRING, description = "hypervisor type of host: XenServer,XEN,KVM,VMware,Hyperv,BareMetal,Simulator")
