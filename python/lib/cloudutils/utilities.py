...
class Distribution:
    def __init__(self):
        ...
        if os.path.exists("/etc/fedora-release"):
            ...
            if version.find("Red Hat Enterprise Linux Server release 6") != -1 or version.find("Scientific Linux release 6") != -1 or version.find("CentOS Linux release 6") != -1 or version.find("CentOS release 6.") != -1 or version.find("XenServer release 6.2.50") != -1:
                self.distro = "RHEL6"
